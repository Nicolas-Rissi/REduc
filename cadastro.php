...
require_once "Back-end/class/users/CategoriaUsuario.class.php";
require_once "Back-end/class/users/Pergunta.class.php";
require_once "Back-end/class/users/RedeSocial.class.php";
            ...
            <form method='POST' action='#' id='form-cadastro'
                ...
                <div class='seguranca d-none'>
                    ...
                    <input type='text' name='resposta' id="resposta" class='form-control'
                           placeholder='Digite a resposta de segurança.'>
                    <br>
